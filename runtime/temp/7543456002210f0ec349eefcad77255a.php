<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\www\tpcms\public/../application/admin\view\cate\addchild.html";i:1543460875;s:54:"D:\www\tpcms\application\admin\view\common\header.html";i:1543226272;s:52:"D:\www\tpcms\application\admin\view\common\left.html";i:1543391003;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div id="content" class="span10">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action='/index.php/admin/cate/tianjia' method='POST'>
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="inputWarning">上级栏目</label>									
									<div class="controls">
							  			<input type="text" name="pname" value="<?php echo $pcname['catename']; ?>" disabled>							  			
							  			<span class="help-inline" style='font-size: 24px;'>*</span>
							  			<input type="hidden" name='pid' value='<?php echo $pcname['id']; ?>'>
									</div>
						  		</div>
							</fieldset>
							<fieldset>
							...
							<fieldset>
								<div class="control-group">
									...
									<div class="controls">
									  <select id="selectError3" name='cate_model' disabled>
							...
							<fieldset>
								...
								<div class="controls">
								  <label class="radio" style='float:left;'>
									<div class="radio" id="uniform-optionsRadios1"><span class="checked"><input type="radio" name="ishide" value="0" <?php if(($data['ishide'] == 0)): ?>checked<?php endif; ?>></span></div>
									是
								  </label>								  
								  <label class="radio" style='float:left;padding-top: 5px;'>
									<div class="radio" id="uniform-optionsRadios2"><span><input type="radio" name="ishide" value="1" <?php if(($data['ishide'] == 1)): ?>checked<?php endif; ?>></span></div>
									否
								  </label>
								</div>
							  </div>
