<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\www\tpcms\public/../application/admin\view\cmodel\add.html";i:1543673183;s:54:"D:\www\tpcms\application\admin\view\common\header.html";i:1543226272;s:52:"D:\www\tpcms\application\admin\view\common\left.html";i:1543655614;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div id="content" class="span10">
				<div class="box span12">
					<div class="box-header">
						<h2><i class="icon-table"></i>添加模型</h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" action='/index.php/admin/cmodel/tianjia/act/edit' method='POST'>							
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="inputWarning">模型名称</label>
									<div class="controls">
							...
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="inputWarning">附加表</label>
									<div class="controls">
							  			<input type="text" name="m_table" value='<?php echo $data['m_table']; ?>'>
							  			<input type="hidden" name="old_table" value='<?php echo $data['m_table']; ?>'>
							  			<span class="help-inline" style='font-size: 24px;'>*</span>
									</div>
						  		</div>
							</fieldset>							
							<fieldset>
								...
								<div class="controls">
								  <label class="radio" style='float:left;'>
									<div class="radio" id="uniform-optionsRadios1" ><span class="checked"><input type="radio" name="m_status" value="0" checked="" <?php if(($data['m_status'] == 0)): ?>checked<?php endif; ?>></span></div>
									否
								  </label>								  
								  <label class="radio" style='float:left;padding-top: 5px;'>
									<div class="radio" id="uniform-optionsRadios2"><span><input type="radio" name="m_status" value="1" <?php if(($data['m_status'] == 1)): ?>checked<?php endif; ?>></span></div>
									是
								  </label>
								</div>
							  </div>
