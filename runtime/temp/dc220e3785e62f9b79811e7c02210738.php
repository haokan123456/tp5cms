<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\www\tpcms\public/../application/admin\view\cate\clst.html";i:1543312939;s:54:"D:\www\tpcms\application\admin\view\common\header.html";i:1543226272;s:52:"D:\www\tpcms\application\admin\view\common\left.html";i:1543308466;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul style="display: block;">
								<li><a class="submenu" href="clst"><i class="icon-hdd"></i><span class="hidden-tablet"> 栏目列表</span></a></li>								
					...
					<div class="box-content">
					  ...
					  <tbody role="alert" aria-live="polite" aria-relevant="all" class='cate_list'>
					  		...
					  		<tr class="odd">
								...
								<td class="center " style='text-align:center;'><?php echo $val['type']; ?></td>
								<td class="center " style='text-align:center;'>
									<span class="label label-success" style='cursor:pointer;'><?php if(($val['ishide'] == 1)): ?>显示<?php else: ?>隐藏<?php endif; ?></span>
	...
	<!-- start: JavaScript-->
		...
		<script>			
			$(function(){			
				...
				var cate=$('.cate_list');
				var fadeout=cate.find('.label-success');
